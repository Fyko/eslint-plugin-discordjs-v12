...
interface ParserServices {
	...
	esTreeNodeToTSNodeMap: WeakMap<Record<string, unknown>, any> | undefined;
	tsNodeToESTreeNodeMap: WeakMap<Record<string, unknown>, any> | undefined;
}
// end
...
declare namespace SourceCode {
	...
	export type FilterPredicate = (tokenOrComment: TSESTree.Token | TSESTree.Comment) => boolean;
...
declare class SourceCode {
	public text: string;
	public ast: AST.Program;
	public lines: string[];
	public hasBOM: boolean;
	public parserServices: ParserServices;
	public scopeManager: Scope.ScopeManager;
	public visitorKeys: SourceCode.VisitorKeys;

	public constructor(text: string, ast: AST.Program);
	// eslint-disable-next-line no-dupe-class-members
	public constructor(config: SourceCode.Config);

	public static splitLines(text: string): string[];

	public getText(node?: TSESTree.Node, beforeCount?: number, afterCount?: number): string;

	public getLines(): string[];

	public getAllComments(): TSESTree.Comment[];

	public getComments(node: TSESTree.Node): { leading: TSESTree.Comment[]; trailing: TSESTree.Comment[] };

	public getJSDocComment(node: TSESTree.Node): TSESTree.Node | TSESTree.Token | null;

	public getNodeByRangeIndex(index: number): TSESTree.Node | null;

	public isSpaceBetweenTokens(first: TSESTree.Token, second: TSESTree.Token): boolean;

	public getLocFromIndex(index: number): TSESTree.LineAndColumnData;

	public getIndexFromLoc(location: TSESTree.LineAndColumnData): number;

	// Inherited methods from TokenStore
	// ---------------------------------

	public getTokenByRangeStart(offset: number, options?: { includeComments?: boolean }): TSESTree.Token | null;

	public getFirstToken(node: TSESTree.Node, options?: SourceCode.CursorWithSkipOptions): TSESTree.Token | null;

	public getFirstTokens(node: TSESTree.Node, options?: SourceCode.CursorWithCountOptions): TSESTree.Token[];

	public getLastToken(node: TSESTree.Node, options?: SourceCode.CursorWithSkipOptions): TSESTree.Token | null;

	public getLastTokens(node: TSESTree.Node, options?: SourceCode.CursorWithCountOptions): TSESTree.Token[];
	...
	public getTokens(node: TSESTree.Node, beforeCount?: number, afterCount?: number): TSESTree.Token[];
	// eslint-disable-next-line no-dupe-class-members
	public getTokens(
		node: TSESTree.Node,
	...
	public commentsExistBetween(left: TSESTree.Node | TSESTree.Token, right: TSESTree.Node | TSESTree.Token): boolean;

	public getCommentsBefore(nodeOrToken: TSESTree.Node | TSESTree.Token): TSESTree.Comment[];

	public getCommentsAfter(nodeOrToken: TSESTree.Node | TSESTree.Token): TSESTree.Comment[];

	public getCommentsInside(node: TSESTree.Node): TSESTree.Comment[];
}
...
interface RuleListener {
	...
	Import?: RuleFunction<TSESTree.ImportClause>;
